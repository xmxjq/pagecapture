========================================================================
    ACTIVE TEMPLATE LIBRARY : CBho Project Overview
========================================================================

AppWizard has created this CBho project for you to use as the starting point for
...
CBho.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CBho.h)
        GUID definitions                                (CBho_i.c)
        A type library                                  (CBho.tlb)
        Marshaling code                                 (CBho_p.c and dlldata.c)

CBho.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CBho.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CBho.pch and a precompiled types file named StdAfx.obj.
...
CBhops.vcxproj
	...
	dlldata.c, CBho_i.c and CBho_p.c which are required
	to build the proxy/stub DLL.

CBhops.vcxproj.filters
